...
class StripePaymentController extends Controller
{
    ...
    public function stripePost(Request $request)
    {
        ...
        Charge::create ([
            ...
            "description" => $request->name . " payment from " . getSystemSetting('type_name'),
        ]);
        ...
        foreach ($products as $product) {
            ...
            $order_product->payment_type = 'stripe';
            // order status
            $order_product->save();
        ...
        try {
            ...
            PDF::loadView('frontend.checkout.invoice', compact('name', 'email', 'order','invoice_number'))
                ->save(invoice_path($invoice_number));
       ...
       /*todo:Ecommerce InvoiceMail*/
        try {
            ...
            PDF::loadView('frontend.checkout.ecom_invoice', compact('name', 'email', 'order','invoice_number'))
                ->save(invoice_path($invoice_number));
