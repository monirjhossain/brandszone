...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            $category_group_id = Category::where('id', $pro->parent_id)->first()->parent_category_id;
            $pro->category_group_id = $category_group_id;
            ...
            /** VERSION 3.2 */
            if(function_exists('write_to_lang_product_file')){
                write_to_lang_product_file($pro->name);
            }
