...
use App\Http\Middleware\PostRequestHandel;
...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'te-amo' =>VendorMiddleware::class,
        'demo'=>PostRequestHandel::class,
        'affiliateApprovedUser'=>\App\Http\Middleware\affiliateApprovedUser::class,
        'affiliateNonApprovedUser'=>\App\Http\Middleware\affiliateNonApprovedUser::class,
