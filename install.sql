...
CREATE TABLE `colors` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `primary_color` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `secondary_color` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `topbar_color` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `topbar_text_color` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `hover_color` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `footer_color` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `footer_text_color` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(3, 'type_name', 'Drew Oneal', NULL, '2021-07-01 08:13:30'),
(4, 'type_footer', 'Dolores delectus od', NULL, '2021-07-01 08:13:31'),
(5, 'type_mail', 'Atque accusantium te', NULL, '2021-07-01 08:13:31'),
(6, 'type_address', 'Anim dolor aut sint', NULL, '2021-07-01 08:13:31'),
(7, 'type_fb', 'Consequatur Autem p', NULL, '2021-07-01 08:13:31'),
(8, 'type_tw', 'Officia ut eveniet', NULL, '2021-07-01 08:13:31'),
(9, 'type_number', '27', NULL, '2021-07-01 08:13:31'),
(10, 'type_google', 'Ipsam et aliquip ea', NULL, '2021-07-01 08:13:31'),
...
(39, 'Kyle Foley', 'kyle-foley', NULL, 'tadeve@mailinator.com', NULL, NULL, 0, 'images/avatar.png', NULL, NULL, NULL, '2021-07-01 08:13:53', '$2y$10$aCCtNkpPQnAzaP3gKNKVOu2F4.XuMw6aSO8X0PqGnfcsj5ZTSx95G', NULL, 'Admin', NULL, '2021-07-01 08:13:54', '2021-07-01 08:13:54', NULL);
