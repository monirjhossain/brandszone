...
@section('title') @translate(Product List) ({{ $lang->code }}) @endsection
@section('content')
    ...
    <div class="card card-primary card-outline">
        <div class="card-header">
            <h3 class="panel-title text-center">@translate(Product Translate)</h3>
        ...
        <div class="card-body">
            <form class="form-horizontal" action="{{ route('language.products.translate.store') }}" method="POST">
                @csrf
                ...
                <div class="panel-body">
                    <table class="table table-striped table-bordered demo-dt-basic" cellspacing="0" width="100%"
                        ...
                        @foreach (trans('products', [], $lang->code) as $key => $value)
                            <tr class="">
                                <td>{{ $loop->index+1 }}</td>
