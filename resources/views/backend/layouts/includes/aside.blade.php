<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <!-- Sidebar -->
    <div class="sidebar v3_backend-submenu">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item has-treeview {{request()->is('dashboard/user*') || 
                request()->is('dashboard/module*') || 
                request()->is('dashboard/permission*') || 
                request()->is('dashboard/group*') || 
                request()->routeIs('users.customer') ? 'menu-open' : null}}">
                    <a href="#"
                    ...
                    <ul class="nav nav-treeview">
                        @canany('user-setup')
                            ...
                            <li class="nav-item">
                                <a href="{{route('users.customer')}}"
                                   class="nav-link {{request()->routeIs('users.customer') ? 'active':null}}">
                                    <i class="far fa-circle nav-icon"></i>
                ...
                @canany('order-manage')
                    <li class="nav-item has-treeview {{request()->is('dashboard/orders*') ||
                       ...
                       request()->is('dashboard/filter/*') || 
                       request()->is('dashboard/order/export/index') ? 'menu-open' : null}}">
                        <a href="{{ route('orders.index') }}"
                           class="nav-link {{ request()->is('dashboard/orders*') || 
                           request()->is('dashboard/order/deliver*') || 
                           request()->is('dashboard/filter/*') || 
                           request()->is('dashboard/find/order*') ||
                           request()->is('dashboard/order/export/index') ? 'active' : null}}">
...
{{--                                    @endif--}}
                                ...
                                @endif
                                    ...
                                    {{-- EXPORT IMPORT --}}
                                    <a href="{{route('order.export.index')}}"
                                       class="nav-link  {{request()->is('dashboard/order/export/index')  ? 'active' : null}}">
                                        <i class="far fa-circle nav-icon"></i>
                ...
                @if(vendorActive())
                    ...
                    @canany('seller')
                        ...
                        <li class="nav-item has-treeview {{request()->is('dashboard/seller/product*') || 
                        request()->is('dashboard/seller/product/request') || 
                        request()->is('dashboard/seller/product/edit*') || request()->is('dashboard/product/search/by/name*') ? 'menu-open' : null}}">
                            <a href="#"
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item {{request()->is('dashboard/seller/products*') 
                                || request()->is('dashboard/seller/product/edit*') 
                                || request()->is('dashboard/product/search/by/name*') ? 'active' : null}}">
                                    <a href="{{route('seller.products')}}"
                                       class="nav-link {{request()->is('dashboard/seller/products*') 
                                       || request()->is('dashboard/seller/product/edit*') 
                                       || request()->is('dashboard/product/search/by/name*') ? 'active' : null}}">
                                        <i class="far fa-circle nav-icon"></i>
                                        @translate(Products)
            ...
            <!-- Promotions START -->
                ...
                @anypermission('section-setting','site-setting')
                 ...
                 || request()->is('dashboard/theme/color')
                 || request()->is('dashboard/org-setting*')
                 || request()->is('dashboard/preloader/settings*') //version 3.2
                 ? 'menu-open' : null}}">
                        <a href="#"
                           class="nav-link
                       ...
                       || request()->is('dashboard/org-setting*') ? 'active' : null}}">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            @canany('site-setting')
                                ...
                                <li class="nav-item">
                                    <a href="{{route('theme.color')}}"
                                       class="nav-link {{ request()->is('dashboard/theme/color') ? 'active':null}}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>@translate(Color Settings)</p>
                                    </a>
                                </li>

                                {{-- version 3.2 --}}
                                <li class="nav-item">
                                    <a href="{{route('preloader.setting')}}"
                                    class="nav-link {{ request()->is('dashboard/preloader/settings') ? 'active':null}}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>@translate(Preloader Settings)</p>
                                     </a>
                                </li>
                                {{-- version 3.2::END --}}
