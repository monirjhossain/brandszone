    ...
    <div class="card card-primary card-outline">
        ...
        <div class="container">
            ...
            <div class="text-center">
                ...
                <a href="{{ route('export.as.csv', generateUuid()) }}" class="btn btn-primary">Export as csv</a>
                <a href="{{ route('export.as.xlsx', generateUuid()) }}" class="btn btn-primary">Export as xlsx</a>
                <a href="{{ route('export.as.xls', generateUuid()) }}" class="btn btn-primary">Export as xls</a>
                <a href="{{ route('export.as.tsv', generateUuid()) }}" class="btn btn-primary">Export as tsv</a>
                <a href="{{ route('export.as.pdf', generateUuid()) }}" class="btn btn-primary">Export as pdf</a>
                    ...
                    {{ $order->status === 'product_dispatched' ? 'bg-product_dispatched' : '' }}
                        ...
                        <td>
                            ...
                            <span class="d-block">
                                    ...
                                    <br>
                            <span class="d-block">
                                        @translate(Transaction ID) - {{ $order->transaction_id ?? 'N/A'}}
                                    </span>
                            <span class="d-block">
                                        @translate(Account No) - {{ $order->bank_account_no ?? 'N/A'}}
                                    </span>

                        </td>
                        <td>
                                    <span class="d-block text-uppercase">
                                       @translate(Payment Type):  <strong class="d-blockbadge badge-info">{{ $order->payment_type }}</strong>
                                    </span>
                        ...
                        <td class="w-20">
                                    ...
                                    <span class="d-block">
                                        @translate(Name) - {{ $order->user != null ? $order->user->name : $order->order->name }}
                                    </span>
                            <span class="d-block">
                            ...
                            @if ($order->status != 'delivered')
                                <td>
                                 ...
                                 && $order->status != 'confirmed'
                                        ...
                                        <a class="btn-sm btn-primary d-block m-2 text-center"
                                            href="{{ route("download.invoice", [$order->order_number, generateUuid()]) }}">
                                            @translate(Invoice)
                                        </a>
