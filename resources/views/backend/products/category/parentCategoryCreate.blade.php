<div class="card-body">
    <form action="{{route('parent.categories.store')}}" method="post" enctype="multipart/form-data">
        <input name="parent_id" type="hidden" value="{{$cat->id}}">
        <input name="parent_slug" type="hidden" value="{{$cat->slug}}">
        @csrf
        ...
        <div class="form-group">
            ...
            <div class="custom-file">
                ...
                <small>@translate(Want more icon) ? <a href="https://fontawesome.com/v5.15/icons?d=gallery&p=2"  target="_blank">Font Awesome</a></small>
            </div>
        </div>
