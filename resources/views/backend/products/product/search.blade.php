...
@section('title') @translate(Product Search)
@endsection
@section('parentPageTitle', 'Product Search')
@section('content')
    @if(!request()->is('dashboard/request/product/index'))
    <div class="card m-2">
        <div class="card-header">
            <div class="float-left">
                <h2 class="card-title">@translate(Products Search)</h2>
            </div>
            <div class="float-right">
               ...
               <div class="row justify-content-end">
                    <div class="col">
                        <form method="get" action="{{ route('product.search.backend') }}">
                            <div class="input-group">
                                <input type="text" name="search" class="form-control col-12"
                                       placeholder="@translate(Search Product)" value="{{Request::get('search')}}">
