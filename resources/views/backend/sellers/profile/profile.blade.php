                ...
                <div class="card-body">
                    ...
                    <!--logo-->
                        ...
                        <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label for="password" class="col-sm-2 col-form-label">@translate(New Password)</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    <label for="password_confirmation" class="col-sm-2 col-form-label">@translate(Confirm Password)</label>
                                    <div class="col-sm-10">
