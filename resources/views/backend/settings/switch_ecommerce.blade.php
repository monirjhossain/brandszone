            ...
            <div class="card-body mt-3 ">
                <form action="{{route('smtp.store')}}" method="post">
                    ...
                    <div class="text-center">
                        <p class="text-white text-uppercase"><span class="bg-primary rounded-sm p-2">@translate(Currently Active) : {{env('APP_ACTIVE')}}</span></p>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="">
                            <select class="form-control select2" name="APP_ACTIVE">
                                <option value="ecommerce" @if (env('APP_ACTIVE') == "ecommerce") selected @endif> @translate(Single Vendor eCommerce) </option>
                                <option value="vendor" @if (env('APP_ACTIVE') == "vendor") selected @endif>@translate(Multi Vendor eCommerce) </option>
                            </select>
                        </div>
                    </div>
