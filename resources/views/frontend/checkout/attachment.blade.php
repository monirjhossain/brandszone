...
<head>
    ...
    <!--<![endif]-->
    <title>{{getSystemSetting('type_name')}}</title>
    <!--[if gte mso 9]>
    ...
    <table width="100%" border="0"   style="margin: 0; padding: 0; width: 100%; height: 100%;" bgcolor="#f4ecfa" class="gwfw">
        <tr>
            <td style="margin: 0; padding: 0; width: 100%; height: 100%;" align="center" valign="top">
                <table width="600" border="0"   class="m-shell">
                    <tr>
                                                                                        ...
                                                                                        <table width="100%" border="0"  >
                                                                                            <tr>
                                                                                                <td class="fluid-img img-center pb-50" style="font-size:0pt; line-height:0pt; text-align:center; padding-bottom: 50px;">
                                                                                                    <img src="{{filePath(getSystemSetting('type_logo'))}}" width="300" height="252" border="0" alt="" />
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td class="title-36 a-center pb-15" style="font-size:36px; line-height:40px; color:#282828; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; text-align:center; padding-bottom: 15px;">
                                                                                                    <strong>@translate(Thanks for your order)!</strong>
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td class="text-16 lh-26 a-center" style="font-size:16px; color:#6e6e6e; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; line-height: 26px; text-align:center;">
                                                                                                    @translate(We&rsquo;ll send tracking information as soon as your order ships).
                                                                                                </td>
                                                                                            </tr>
                                                                                        </table>
                                                                                    </td>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td class="btn-20 btn-secondary c-white l-white" bgcolor="#f3189e" style="font-size:20px; line-height:24px; mso-padding-alt:15px 35px; font-family:'PT Sans', Arial, sans-serif; text-align:center; font-weight:bold; text-transform:uppercase; min-width:auto !important; border-radius:10px; background:linear-gradient(to right, #9028df 0%,#f3189e 100%); color:#ffffff;">
                                                                                                                <a href="#" target="_blank" class="link c-white" style="display: block; padding: 15px 35px; text-decoration:none; color:#ffffff;">
                                                                                                                    <span class="link c-white" style="text-decoration:none; color:#ffffff;">@translate(ORDER): #{{ $order->order_number }}</span>
                                                                                                                </a>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                    </table>
                                                                                                                ...
                                                                                                                <table width="100%" border="0"  >
                                                                                                                    <tr>
                                                                                                                        <td class="title-20 pb-10" style="font-size:20px; line-height:24px; color:#282828; font-family:'PT Sans', Arial, sans-serif; text-align:left; min-width:auto !important; padding-bottom: 10px;">
                                                                                                                            <strong>@translate(Shipping details)</strong>
                                                                                                                        </td>
                                                                                                                    </tr>
                                                                                                                    <tr>
                                                                                                                        <td class="text-16" style="font-size:16px; line-height:20px; color:#6e6e6e; font-family:'PT Sans', Arial, sans-serif; text-align:left; min-width:auto !important;">
                                                                                                                            {{ $name }}
                                                                                                                            <br />
                                                                                                                            {{ $order->address }}, {{ $order->division->district_name }}, {{ $order->area->thana_name }}
                                                                                                                            <br />
                                                                                                                            {{ $email }}
                                                                                                                            <br />
                                                                                                                            @translate(Phone): {{ $order->phone }}
                                                                                                                        </td>
                                                                                                                    </tr>
                                                                                                                </table>
                                                                                                            </th>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td class="pb-30" style="padding-bottom: 30px;">
                                                                                                        <table width="100%" border="0"  >
                                                                                                            <tr>
                                                                                                                <th class="column-top" valign="top" width="230" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal; vertical-align:top;">
                                                                                                                    <div class="fluid-img" style="font-size:0pt; line-height:0pt; text-align:left;"><a href="#" target="_blank"><img src="{{ filePath( $product->product->product->image ) }}" border="0" width="230" height="180" alt="" /></a></div>
                                                                                                                </th>
                                                                                                                <th class="column-top mpb-15" valign="top" width="30" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal; vertical-align:top;"></th>
                                                                                                                <th class="column-top" valign="top" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal; vertical-align:top;">
                                                                                                                    <table width="100%" border="0"  >
                                                                                                                        <tr>
                                                                                                                            <td class="title-20 pb-10" style="font-size:20px; line-height:24px; color:#282828; font-family:'PT Sans', Arial, sans-serif; text-align:left; min-width:auto !important; padding-bottom: 10px;">
                                                                                                                                <strong>@translate(Booking Code): #{{ $product->booking_code }}</strong>
                                                                                                                            </td>
                                                                                                                        </tr>
                                                                                                                        <tr>
                                                                                                                        ...
                                                                                                                        <tr>
                                                                                                                            <td class="text-16 lh-26 c-black" style="font-size:16px; font-family:'PT Sans', Arial, sans-serif; text-align:left; min-width:auto !important; line-height: 26px; color:#282828;">
                                                                                                                                <strong>@translate(Shop):</strong> {{ $product->shop->shop_name ?? '' }}
                                                                                                                                <br />
                                                                                                                                <strong>@translate(Qty):</strong> {{ $product->quantity }}
                                                                                                                                <br />
                                                                                                                                <strong>@translate(Price):</strong> {{ formatPrice($product->product_price) }}
                                                                                                                            </td>
                                                                                                                        </tr>
                                                                                                                    </table>
                                                                                                                </th>
                                                                                                            ...
                                                                                                            <th class="column-top" valign="top" width="230" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal; vertical-align:top;">
                                                                                                                <table width="100%" border="0"  >
                                                                                                                    ...
                                                                                                                    <tr>
                                                                                                                        <td align="right">
                                                                                                                            <!-- Button -->
                                                                                                                            <table border="0"   class="mw-100p" style="min-width: 200px;">
                                                                                                                                <tr>
                                                                                                                                    <td class="btn-20 btn-secondary c-white l-white" bgcolor="#f3189e" style="font-size:20px; line-height:24px; mso-padding-alt:15px 35px; font-family:'PT Sans', Arial, sans-serif; text-align:center; font-weight:bold; text-transform:uppercase; min-width:auto !important; border-radius:10px; background:linear-gradient(to right, #9028df 0%,#f3189e 100%); color:#ffffff;">
                                                                                                                                        <a href="#" target="_blank" class="link c-white" style="display: block; padding: 15px 35px; text-decoration:none; color:#ffffff;">
                                                                                                                                            <span class="link c-white" style="text-decoration:none; color:#ffffff;">@translate(TOTAL): {{ formatPrice($order->pay_amount) }}</span>
                                                                                                                                        </a>
                                                                                                                                    </td>
                                                                                                                                </tr>
                                                                                                                            </table>
                                                    ...
                                                    <table width="100%" border="0"  >
                                                        <tr>
                                                            <td class="text-14 lh-24 a-center c-white l-white pb-20" style="font-size:14px; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; line-height: 24px; text-align:center; color:#ffffff; padding-bottom: 20px;">
                                                                ...
                                                                <br />
                                                                <a href="tel:{{getSystemSetting('type_number')}}" target="_blank" class="link c-white" style="text-decoration:none; color:#ffffff;"><span class="link c-white" style="text-decoration:none; color:#ffffff;">{{getSystemSetting('type_number')}}</span></a>
                                                                <br />
                                                                <a href="mailto:{{getSystemSetting('type_mail')}}" target="_blank" class="link c-white" style="text-decoration:none; color:#ffffff;"><span class="link c-white" style="text-decoration:none; color:#ffffff;">{{getSystemSetting('type_mail')}}</span></a> - <a href="{{url('/')}}" target="_blank" class="link c-white" style="text-decoration:none; color:#ffffff;"><span class="link c-white" style="text-decoration:none; color:#ffffff;">{{url('/')}}</span></a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
