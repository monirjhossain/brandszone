                        ...
                        <ul class="ps-list--categories">
                            ...
                            @foreach (categories(10, null) as $home_category)
                                <li class="current-menu-item menu-item-has-children"><a
                                        ...
                                        class="sub-toggle {{ $parent_slug == $home_category->slug ? 'active' : null }}"><i class="fa fa-angle-down"></i></span>
                                    <ul class="sub-menu" style="display: {{ $parent_slug == $home_category->slug ? 'block' : null }}">
                                        @foreach($home_category->childrenCategories as $parent_Cat)
                                            @foreach($parent_Cat->childrenCategories as $sub_cat)
                            ...
                            <div class="ps-tab" id="tab-2">
                                <div class="ps-shopping-product">
                                    @foreach($category_products as $category_product)
                                        ...
                                        @foreach($category_product->frontCategoryProducts as $cat_product)
                                            @foreach($cat_product->CategoryProducts as $list_products)
                                                    <div class="ps-product ps-product--wide">
                                                        <div class="ps-product__thumbnail"><a
                                                                    href="{{ route('single.product',[$list_products->sku,$list_products->slug]) }}">
                                                                <img src="{{ filePath($list_products->image) }}" class="rounded"
                                                                     alt="#{{ $list_products->name }}"></a>
                                                        </div>
                                                        <div class="ps-product__container">
                                                            <div class="ps-product__content"><a class="ps-product__title"
                                                                                                href="{{ route('single.product',[$list_products->sku,$list_products->slug]) }}">{{ $product->name }}</a>
                                                                {!! $list_products->short_desc !!}
                                                            </div>
                                                            <div class="ps-product__shopping">
                                                                <p class="ps-product__price">
                                                                @if($list_products->is_discount)
                                                                    <p class="ps-product__price sale">{{formatPrice($list_products->discount_price)}}
                                                                        <del>
                                                                            {{formatPrice($list_products->product_price)}}</del>
                                                                    </p>
                                                                @else
                                                                    <p class="ps-product__price">{{formatPrice($list_products->product_price)}}</p>
                                                                    @endif
                                                                    </p>
                                                                    <a class="ps-btn"
                                                                       href="{{ route('single.product',[$list_products->sku,$list_products->slug]) }}">@translate(Buy Now)</a>
                                                                    <ul class="ps-product__actions">
                                                                        <li>
                                                                            @auth()
                                                                                <a data-toggle="tooltip" data-placement="top"
                                                                                   title="Add to Whishlist" href="#!"
                                                                                   onclick="addToWishlist({{$list_products->id}})"><i
                                                                                            class="icon-heart"></i></a>
                                                                            @endauth
                                                                            @guest()
                                                                                <a 
                                                                ...
                                                                >
                                                                    <i class="fas fa-heart"></i>
                                                                        ...
                                                                        <li>
                                                                            <a href="#!" onclick="addToCompare({{$list_products->id}})"
                                                                               data-toggle="tooltip" data-placement="top"
                                                                               title="Compare"><i class="fa fa-random"></i>
                                                                            </a>
                                                                        </li>
