                                ...
                                <div class="product-cont-box text-center">
                                                            <h5>
                                                                <a href="{{route('single.product',[$brand_product->sku,$brand_product->slug])}}">
                                                                    {{\Illuminate\Support\Str::limit($brand_product->name,20)}}
                                                                </a>
                                                            </h5>
                                ...
                                <div class="product-cont-box text-center">
                                                            <h5>
                                                                <a href="{{route('single.product',[$single_product->sku,$single_product->slug])}}">
                                                                    {{\Illuminate\Support\Str::limit($single_product->name,20)}}
                                                                </a>
                                                            </h5>
                                                            <div class="price text-center d-flex justify-content-center">
                                                                @if (vendorActive())
                                                                ...
                                                                @if($single_product->is_discount)
                                                                    <span class="">
                                                                    {{formatPrice($single_product->discount_price)}}
                                                                </span>
                                                                    <del class="">
                                                                    {{formatPrice($single_product->product_price)}}
                                                                </del>
                                                                @else
                                                                    <span class="">
                                                                    {{formatPrice($single_product->product_price)}}
                                                        ...
                                                        <div class="icons-link-wrapper">
                                                            ...
                                                            @guest()
                                                                    ...
                                                                    data-product_price='{{formatPrice(brandProductPrice($single_product->sellers)->min())
                                                                                                    ...
                                                                                                    ? formatPrice(brandProductPrice($single_product->sellers)->min())
                                                                                                    : formatPrice(brandProductPrice($single_product->sellers)->min()).
                                                                                                    '-' .formatPrice(brandProductPrice($single_product->sellers)->max())}}'><span class="heart social_icon"><i class="fas fa-heart"></i></span></a>
                                                            @endguest

                                                            <a href="javascript:;" onclick="addToCompare({{$single_product->id}})"><span class="reload social_icon"><i class="fa fa-random"></i></span></a>
                                                            <a href="javascript:;" onclick="forModal('{{ route('quick.view',$single_product->slug) }}', '@translate(Product quick view)')"><span class="preview social_icon" ><i class="fa fa-eye"></i></span></a>
                                                        </div>
