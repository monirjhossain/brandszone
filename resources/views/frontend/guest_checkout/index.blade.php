...
@section('content')
		...
		<div class="ps-checkout ps-section--shopping">
			<div class="container">
				<div class="ps-section__header">
					<h1>@translate(Checkout as Guest) </h1>
					@translate(Or)<br/>
					<a href="{{route('checkout.index')}}" class="ps-btn ps-btn--sm">@translate(Login)</a>
				</div>
								...
								<div class="ps-form__total">
									...
									<div class="content">
										<div class="ps-block--checkout-total">
											<div class="ps-block__content">
												<table class="table ps-block__products">
													...
													{{--loop ajax result item[4] and append--}}
													</tbody>
												</table>
										...
										<div class="card rounded-sm">
											<button type="button" class="ps-btn ps-btn--outline w-100"
											        id="order_now_btn">
												Order Now
											</button>
										</div>
										...
										<div id="order_now" class="d-none">
											...
											{{-- BANK TRANSFER --}}
												...
												<div class="accordion my-2" id="bankPaymentMethodExample">
                                                    ...
                                                    <span class="d-block font-size-16 text-center font-weight-bold">
                                                             @translate(Direct Bank Payment)
                                                    </span>
																</label>
														...
														<div id="collapse" class="collapse border-bottom"
														     ...
														     data-parent="#bankPaymentMethodExample">
															<div class="card-body mb-3">
																<div class="contact-form-action">

																	<div class="input-box">
																		<div class="form-group text-center">
                                                                             <img src="{{filePath(getSystemSetting('bank_qrcode'))}}" class="img-fluid" width="300" alt="">
																		</div>
																	</div>
																	<div class="input-box">
																		<label class="label-text">@translate(Transaction ID)<span
																	...
																	<div class="input-box">
																		<label class="label-text">@translate(Bank Account No)<span
																					class="primary-color-2 ml-1">*</span></label>
																		<div class="form-group">
                                                                         
																			<input class="form-control" required
																			       name="bank_account_no" type="text" value=""
																	...
																	<button type="button"
																	        class="ps-btn ps-btn--fullwidth bg-dark" id="placeOrderBank">
																		@translate(Pay Now)
																	</button>
																</div>
															</div>
											...
											@if(env('STRIPE_KEY') != "" &&  env('STRIPE_SECRET') != "")
												...
												<div class="accordion my-2" id="paymentMethodExample">
                                                    ...
                                                    <span
                                                            ...
                                                            <img src="{{filePath('stripe.png')}}" height="18px"
														...
														<div id="collapse" class="collapse border-bottom"
															...
															<div class="card-body mb-3">
																<div class="contact-form-action">
																	...
																	<div class="input-box">
																		<label class="label-text">@translate(Name on
																			Card)
																			<span
																					class="primary-color-2 ml-1">*</span></label>
																		<div class="form-group">
											...
											<div class="form-group">
												<button type="button" id="placeOrder"
												        class="ps-btn ps-btn--outline w-100">
	...
	<input type="hidden" id="placeorderbank_route" value="{{ route('place.order.bank') }}"> 
@stop
...
@section('js')
	...
	<script>
		...
		// BANK PAYMENT
		$('#placeOrderBank').on('click', function (e) {
            var placeurl = $('#placeorderbank_route').val();
            var b = document.getElementById("orderForm");
            b.setAttribute('action', placeurl);
            var name = $("#name").val();
            var email = $("#email").val();
