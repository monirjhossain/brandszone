            ...
            <div class="header__left">
                <div class="menu--product-categories">
                    <div class="menu__toggle">
                        <i class="icon-menu text-white"></i><span class="text-white"> @translate(Categories)</span>
                    </div>
        ...
        <!-- end -->
            ...
            <div class="header__center position-relative">
                <form class="ps-form--quick-search" id="search-form" action="{{route('product.search')}}" method="get">
                    ...
                    <input class="form-control" name="key" id="filter_input" type="text"  value="{{Request::get('key')}}" placeholder="@translate(I am looking for)...">
            ...
            <div class="header__right">
                <div class="header__actions">
                    ...
                    <div class="ps-cart--mini">
                        <a class="header__extra" href="javascript:;"><i class="icon-heart"></i>
                            <span>
