...
@section('title')
- {{ trans('products.'. $single_product->name) }}
@stop
    ...
    <div class="ps-breadcrumb">
        <div class="ps-container">
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="{{ route('category.shop', $single_product->childcategory->name) }}">{{ trans('categories.'. $single_product->childcategory->name) }}</a>
                </li>
                <li>{{ trans('products.'. $single_product->name) }}</li>
            </ul>
        </div>
    </div>
                ...
                <div class="ps-page__left">
                    <div class="ps-product--detail ps-product--fullwidth">
                        <div class="ps-product__header">
                            <div class="ps-product__thumbnail wow fadeInUp" data-vertical="true">
                                <figure>
                            ...
                            <div class="ps-product__info wow fadeInUp">
                                <h1>{{ trans('products.'. $single_product->name) }}</h1>
...
data-toggle="tooltip" data-placement="top" data-title="@translate(Add to comparison)"><i
                                ...
                                <div class="ps-product__specification">
                                    <p><strong>@translate(SKU):</strong> {{ $single_product->sku }}</p>
                                    <p class="categories"><strong> @translate(Categories):</strong>
                                        
                                        <a href="{{ route('category.shop',$single_product->childcategory->slug) }}"> {{ trans('categories.'. $single_product->childcategory->name) }}</a>
                                    </p>
                        ...
                        <div class="row p-lr-20 seller-div wow fadeInUp">
                        ...
                        <div class="ps-product__content ps-tab-root wow fadeInUp">
                            <ul class="ps-tab-list">
                                <li class="active"><a href="#tab-1">@translate(Description)</a></li>
                                <li>
                                    <a href="#tab-4">@translate(Reviews) ({{ $reviews_count = 0 ? 0 : $reviews_count }})
                                    </a>
                                </li>
                            </ul>
                            <div class="ps-tabs">
                ...
                <div class="ps-page__right">
                    ...
                    <aside class="widget widget_same-brand wow fadeInUp">
                            ...
                            @forelse($brand_products as $brand_product)
                                ...
                                <div class="upper-content">
                                    ...
                                    @if($brand_product->is_discount)
                                        <span class="batch">@translate(sale)</span>
                                    @endif
                                ...
                                <div class="product-cont-box text-center">
                                                            <h5>
                                                                <a href="{{route('single.product',[$brand_product->sku,$brand_product->slug])}}">
                                                                    {{\Illuminate\Support\Str::limit( trans('products.' . $brand_product->name),20)}}
                                                                </a>
                                                            </h5>
                                                            <div class="price text-center d-flex justify-content-center">
                                                                ...
                                                                @if($brand_product->is_discount)
                                                                    <span class="">
                                                                    {{formatPrice($brand_product->discount_price)}}
                                                                </span>
                                                                    <del class="">
                                                                    {{formatPrice($brand_product->product_price)}}
                                                                </del>
                                                                @else
                                                                    <span class="">
                                                                    {{formatPrice($brand_product->product_price)}}
                                                        ...
                                                        <div class="icons-link-wrapper">
                                                            ...
                                                            @auth()
                                                                <a href="javascript:;" onclick="addToWishlist({{$brand_product->id}})">
                                                            ...
                                                            @guest()
                                                                    ...
                                                                    data-product_price='{{formatPrice(brandProductPrice($brand_product->sellers)->min())
                                                                                                    ...
                                                                                                    ? formatPrice(brandProductPrice($brand_product->sellers)->min())
                                                                                                    : formatPrice(brandProductPrice($brand_product->sellers)->min()).
                                                                                                    '-' .formatPrice(brandProductPrice($brand_product->sellers)->max())}}'><span class="heart social_icon"><i class="fas fa-heart"></i></span></a>
                                                            @endguest

                                                            <a href="javascript:;" onclick="addToCompare({{$brand_product->id}})"><span class="reload social_icon"><i class="fa fa-random"></i></span></a>
                                                            <a href="javascript:;" onclick="forModal('{{ route('quick.view',$brand_product->slug) }}', '@translate(Product quick view)')"><span class="preview social_icon" ><i class="fa fa-eye"></i></span></a>
                                                        </div>
            ...
            <div class="ps-section--default wow fadeInUp">
                        ...
                        <div class="ps-carousel--nav owl-slider" data-owl-auto="true" data-owl-loop="true"
                            ...
                            <div class="single-product">
                                <div class="upper-content">
                                    ...
                                    @if($related_product->is_discount)
                                        <span class="batch">@translate(sale)</span>
                                    @endif
                                ...
                                <div class="product-cont-box text-center">
                                                            <h5>
                                                                <a href="{{route('single.product',[$related_product->sku,$related_product->slug])}}">
                                                                    {{\Illuminate\Support\Str::limit( trans('products.' . $related_product->name),20)}}
                                                                </a>
                                                            </h5>
                                                            <div class="price text-center d-flex justify-content-center">
                                                                @if (vendorActive())
                                                                ...
                                                                @if($related_product->is_discount)
                                                                    <span class="">
                                                                    {{formatPrice($related_product->discount_price)}}
                                                                </span>
                                                                    <del class="">
                                                                    {{formatPrice($related_product->product_price)}}
                                                                </del>
                                                                @else
                                                                    <span class="">
                                                                    {{formatPrice($related_product->product_price)}}
                                                        ...
                                                        <div class="icons-link-wrapper">
                                                            ...
                                                            @auth
                                                                <a href="javascript:;" onclick="addToWishlist({{$related_product->id}})">
                                                                    <span class="heart social_icon"><i class="fas fa-heart"></i></span>
                                                                </a>
                                                            @endauth
                                                            ...
                                                            @guest
                                                                    ...
                                                                    data-product_price='{{formatPrice(brandProductPrice($related_product->sellers)->min())
                                                                                                    ...
                                                                                                    ? formatPrice(brandProductPrice($related_product->sellers)->min())
                                                                                                    : formatPrice(brandProductPrice($related_product->sellers)->min()).
                                                                                                    '-' .formatPrice(brandProductPrice($related_product->sellers)->max())}}'><span class="heart social_icon"><i class="fas fa-heart"></i></span></a>
                                                            @endguest

                                                            <a href="javascript:;" onclick="addToCompare({{$related_product->id}})"><span class="reload social_icon"><i class="fa fa-random"></i></span></a>
                                                            <a href="javascript:;" onclick="forModal('{{ route('quick.view',$related_product->slug) }}', '@translate(Product quick view)')"><span class="preview social_icon" ><i class="fa fa-eye"></i></span></a>
                                                        </div>
