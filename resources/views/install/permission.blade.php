...
@section('content')
    <div class="text-center">
        <h1 class="ont-weight-bold">Checking file & extension permissions</h1>
    ...
    <div class="m-5">
        <ul class="list-group">
            <li class="list-group-item text-semibold">
                ...
                Php version 7.4 +
                <br>
                <small class="text-bold"> Your Current Php Version is {{$phpVersion}}</small>
                @if ($phpVersion >= 7.4)
    ...
    <p class="m-2">
        @if ($permission['curl_enabled'] == 1 && $permission['db_file_write_perm'] == 1 &&  $phpVersion >= 7.40 && extension_loaded('zip'))
